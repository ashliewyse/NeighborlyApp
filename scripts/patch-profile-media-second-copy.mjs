...
replaceOnce(
  ...
  'second profile media status',
);

fs.writeFileSync(file, s);
console.log('Patched persistent media on second personal profile implementation.');
