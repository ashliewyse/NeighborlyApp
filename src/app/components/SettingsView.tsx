    ...
    <div className="min-h-screen bg-purple-950 font-['DM_Sans',sans-serif] pb-10">
      <div className="sticky top-0 z-40 bg-white border-b border-border shadow-sm">
        <div className="max-w-3xl mx-auto px-4 h-14 flex items-center gap-3">
          <button onClick={onBack} className="p-1 text-muted-foreground hover:text-foreground" aria-label="Back">
            <ChevronLeft size={20} />
          </button>
          <div>
            <h1 className="font-['Playfair_Display',serif] font-bold text-lg">Settings</h1>
            <p className="text-xs text-muted-foreground">Manage your Neighborly account</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-4">
        ...
        <section className="bg-white rounded-xl border border-border p-5">
          ...
          <input
            ...
            className="w-full bg-muted rounded-lg px-3 py-2.5 text-sm border border-transparent focus:outline-none focus:ring-2 focus:ring-primary/20"
          />
          ...
          <button
            ...
            className="mt-3 bg-primary text-primary-foreground px-4 py-2 rounded-lg text-sm font-medium disabled:opacity-40"
          >
            Update Email
          </button>
        </section>
        ...
        <section className="bg-white rounded-xl border border-border p-5">
          ...
          <div className="space-y-3">
            <div>
              <label className="text-xs font-semibold uppercase tracking-wide text-muted-foreground block mb-1">New password</label>
              <input
                type="password"
                value={password}
            ...
            <div>
              <label className="text-xs font-semibold uppercase tracking-wide text-muted-foreground block mb-1">Confirm password</label>
              <input
                type="password"
        ...
        <section className="bg-white rounded-xl border border-border p-5">
          ...
          <button
            onClick={signOut}
            disabled={busy}
            className="flex items-center gap-2 border border-red-200 bg-red-50 text-red-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-100 disabled:opacity-40"
          >
